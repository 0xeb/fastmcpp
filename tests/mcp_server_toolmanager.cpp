...
int main() {
  ...
  tools::Tool echo{
      "echo",
      Json{{"type","object"},{"properties", Json::object({{"text", Json{{"type","string"}}}})},{"required", Json::array({"text"})}},
      Json{{"type","string"}},
      [](const Json& in){ return Json{{"content", Json::array({ Json{{"type","text"},{"text", in.at("text").get<std::string>()}} })}}; }
  };
