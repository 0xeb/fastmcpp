...
void test_any_of_accepts_first_match()
{
    ...
    Json schema = {{"anyOf", Json::array({Json{{"type", "integer"}}, Json{{"type", "string"}}})}};
...
void test_any_of_rejects_no_match()
{
    ...
    try
    {
        json_schema_to_value(schema, Json::array());
    }
    catch (...)
    {
        threw = true;
...
void test_one_of_accepts_match()
{
    ...
    Json schema = {{"oneOf", Json::array({Json{{"type", "integer"}}, Json{{"type", "string"}}})}};
...
void test_nested_object_rejects_invalid()
{
    ...
    try
    {
        json_schema_to_value(schema, Json{{"user", {{"age", 30}}}});
    }
    catch (...)
    {
        threw = true;
...
void test_nested_union_in_array()
{
    ...
    Json schema = {{"type", "array"}, {"items", {{"type", Json::array({"integer", "string"})}}}};
...
void test_string_const_rejects_invalid()
{
    ...
    try
    {
        json_schema_to_value(schema, "development");
    }
    catch (...)
    {
        threw = true;
...
void test_number_const_rejects_invalid()
{
    ...
    try
    {
        json_schema_to_value(schema, 42);
    }
    catch (...)
    {
        threw = true;
...
void test_boolean_const()
{
    ...
    try
    {
        json_schema_to_value(schema, false);
    }
    catch (...)
    {
        threw = true;
...
void test_object_with_consts()
{
    ...
    Json schema = {
        {"type", "object"},
        {"properties", {{"env", {{"const", "production"}}}, {"version", {{"const", 1}}}}}};
...
void test_array_of_objects()
{
    ...
    auto v = json_schema_to_value(schema, Json::array({Json{{"id", 1}}, Json{{"id", 2}}}));
    auto j = schema_value_to_json(v);
    assert(j[0]["id"] == 1);
    assert(j[1]["id"] == 2);
    std::cout << "  [PASS]\n";
...
void test_object_required_missing()
{
    ...
    try
    {
        json_schema_to_value(schema, Json::object());
    }
    catch (...)
    {
        threw = true;
...
void test_object_additional_properties_false()
{
    ...
    try
    {
        json_schema_to_value(schema, Json{{"name", "Alice"}, {"extra", "bad"}});
    }
    catch (...)
    {
        threw = true;
