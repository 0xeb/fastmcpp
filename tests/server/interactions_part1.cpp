/// @file tests/server/interactions_part1.cpp
/// @brief Server interaction tests - Part 1/3: Core Tools, Resources, Prompts
...
int main()
{
    std::cout << "Running server interaction tests (Part 1/3)...\n\n";
    ...
    try
    {
        ...
        std::cout << "\n[OK] All server interaction tests passed! (55 tests in Part 1)\n";
        return 0;
    }
