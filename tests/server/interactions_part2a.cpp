/// @file tests/server/interactions_part2a.cpp
/// @brief Server interaction tests - Part 2a/3: Data types, Validation (Tests 1-30)
...
int main()
{
    std::cout << "Running server interaction tests (Part 2a/3)...\n\n";
    ...
    try
    {
        ...
        std::cout << "\n[OK] All server interaction tests passed! (30 tests in Part 2a)\n";
        return 0;
    }
